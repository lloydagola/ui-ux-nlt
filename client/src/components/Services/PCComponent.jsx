  ...
  render() {
    return (
      <section className="services">
        ...
        >
          <div
            className="training wow fadeInUp white-transparent"
            data-wow-iteration="1"
            data-wow-offset="80"
            data-wow-delay=".15s"
          >
        ...
        >
          <div
            className="research wow fadeInUp white-transparent"
            data-wow-iteration="1"
            data-wow-offset="80"
            data-wow-delay=".15s"
          >
        ...
        >
          <div
            className="consultancy wow fadeInUp white-transparent"
            data-wow-iteration="1"
            data-wow-offset="80"
            data-wow-delay=".15s"
          >
